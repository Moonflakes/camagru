...
<html>
    <body>
        <div align="center">
            <a href="http://'.$_SERVER['HTTP_HOST'].str_replace("/send_confirm.php", "", $_SERVER['PHP_SELF']).'/include/confirm.php?uid='.urlencode($_SESSION['u_uid']).'&key='.urlencode($_SESSION['u_key']).'&resend=1">Confirmez votre compte !</a>
        </div>
    </body>
</html>
';
